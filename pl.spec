...
%changelog
* Tue Jun 29 2010 Petr Pisar <ppisar@redhar.com> - 5.7.11-6
- Inhibit XPCE by macro to silent rpmlint (Resolves: #607476)
- Define implicit attributes for jpl files (Resolves: #607476)
- Expand tabs to spaces to silent rpmlint (Resolves: #607476)
- Remove executable bit from jpl documentation files (Resolves: #607476)
- Fix spelling in package descriptions (Resolves: #607476)
- Strip debuginfo from libpl.so by setting executable bit (Resolves: #607476)
- Change license to reflect reality (yes, Artistic1) (Resolves: #607476)
- Disable java part on non-x86 architectures (bug #606846)

* Mon Nov 23 2009 Dennis Gregorovic <dgregor@redhat.com> - 5.7.11-5.1
- Rebuilt for RHEL 6
